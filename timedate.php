                ...
                <div class="col-md-5">
                    <div class="left-side">
                        ...
                        <div class="tabs-content">
                            <h4> Welcome <?php echo $_SESSION['fname']; ?>,Find Our Available Agents  </h4>
                    ...
                    <section id="first-tab-group" class="tabgroup">
                        <div id="tab1">
                            <div class="submit-form">
                                <h4>Check availability for <em>agents ,<?php echo $_SESSION['fname']; ?></em>:</h4>
                                <form id="form-submit" action="datesearch.php" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <fieldset>
                                                <button type="submit" id="form-submit" class="btn" name="submit">Search For agents</button>
                                            </fieldset>
                                        </div>
                                    </div>
                                </form>
